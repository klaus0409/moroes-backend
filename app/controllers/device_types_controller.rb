class DeviceTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @device_type.save
        format.html { redirect_to device_types_url, notice: 'Device type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @device_type.update(device_type_params)
        format.html { redirect_to device_types_url, notice: 'Device type was successfully updated.' }
  ...
  private
    ...
    def device_type_params
      params.require(:device_type).permit(:name, :note)
    end
end
